...
| **7** | **- Tham gia sự kiện: AWS Cloud Mastery - Infrastructure as Code (IaC)**<br>+ Tổng quan về IaC và so sánh các công cụ phổ biến (CloudFormation, CDK, Terraform)<br>+ Nắm bắt best practices trong quản lý hạ tầng bằng code | 04/04/2026 | 04/04/2026 | [Sự kiện 4](../../4-eventparticipated/4.4-event4/) |
